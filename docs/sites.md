...
The runtime carries OpenCLI's adapter corpus (170+ sites, ~1300 commands: Bilibili, Zhihu, Xiaohongshu, Twitter/X, Reddit, HackerNews, LinkedIn, YouTube, Amazon, GitHub, Notion, ChatGPT/Gemini/Claude web…; Electron desktop-app adapters are excluded because this runtime drives Chrome only). They are not all loaded as tools.
