...
The runtime carries OpenCLI's adapter corpus (170+ sites, ~1300 commands: Bilibili, Zhihu, Xiaohongshu, Twitter/X, Reddit, HackerNews, LinkedIn, YouTube, Amazon, GitHub, Notion, ChatGPT/Gemini/Claude web, Electron apps…). They are not all loaded as tools.
